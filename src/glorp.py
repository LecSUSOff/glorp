...
global_statement: py_import | import_stmt | var_decl | func | private | watch_stmt | class_def | container_def | immute
...
class_def: "class" name (":" name)? ("(" parameters ")")? body
...
_type: ("func"|"op" ("<"_type_anotation ":" _type_anotation">")? | "num" | "str" | "bool" | "null" | "list" ("[" _type_anotation "]")? | "dict" ("<" _type_anotation ":" _type_anotation ">")? | "any" | "iter") "?"?

_type_anotation: "("? _type ("," _type)* ")"?

body: ("{" (local_statement "\n")* "}") | ("->" local_statement) | (return_stmnt)
...
name: ((_type_anotation " ")? (NAME | element)("."(NAME | element))*)
